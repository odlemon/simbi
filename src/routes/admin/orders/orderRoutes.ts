...
router.get("/:id/payment", authenticateAdmin, requireAnyAdmin, controller.getOrderPaymentDetails.bind(controller));
...
router.post("/:id/record-payment", authenticateAdmin, requireAnyAdmin, controller.recordPayment.bind(controller));
