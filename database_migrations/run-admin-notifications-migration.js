/**
 * Database Migration Runner - Admin Notifications
 * 
 * This script runs the admin notifications migration SQL file
...
async function runMigration() {
  ...
  try {
    ...
    const sqlFile = path.join(__dirname, 'add_admin_notifications.sql');
